...
# comment sections to get section wise o/p

# Method 1 - Async Iterators for Streaming
nest_asyncio.apply()

# agent = Agent(model='anthropic.claude-3-5-sonnet-20241022-v2:0', tools=[calculator], callback_handler=None)
...
#     if "data" in event: # Only show first 20 chars of each chunk for demo purposes
